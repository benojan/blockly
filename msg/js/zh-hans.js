...
Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "为假，则执行";
Blockly.Msg.LOGIC_TERNARY_IF_TRUE = "为真，则执行";
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "检查“如果”中的条件。若条件为真，则返回“为真”的值，否则，则返回“为假”的值。";
...
Blockly.Msg.MATH_MODULO_TITLE = "取%1 ÷ %2的余数";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "取随机小数";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "取（包含）0.0到1.0之间的随机小数。";
Blockly.Msg.MATH_RANDOM_INT_HELPURL = "https://zh.wikipedia.org/wiki/随机数生成器";
Blockly.Msg.MATH_RANDOM_INT_TITLE = "取 %1 到 %2 之间的随机整数";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "取（包含）两个整数之间的随机整数。";
...
Blockly.Msg.TEXT_APPEND_APPENDTEXT = "中追加文本";
Blockly.Msg.TEXT_APPEND_HELPURL = "https://github.com/google/blockly/wiki/Text#text-modification";  // untranslated
Blockly.Msg.TEXT_APPEND_TO = "在";
Blockly.Msg.TEXT_APPEND_TOOLTIP = "将一些文本追加到变量“%1”中。";
...
Blockly.Msg.TEXT_CHARAT_FIRST = "取首个字符";
Blockly.Msg.TEXT_CHARAT_FROM_END = "中取倒数第";
Blockly.Msg.TEXT_CHARAT_FROM_START = "中取第";
Blockly.Msg.TEXT_CHARAT_HELPURL = "https://github.com/google/blockly/wiki/Text#extracting-text";  // untranslated
Blockly.Msg.TEXT_CHARAT_INPUT_INTEXT = "在文本";
Blockly.Msg.TEXT_CHARAT_LAST = "取最后一个字符";
Blockly.Msg.TEXT_CHARAT_RANDOM = "取随机字符";
Blockly.Msg.TEXT_CHARAT_TAIL = "个字符";
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = "个到倒数第";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = "个到第";
Blockly.Msg.TEXT_GET_SUBSTRING_END_LAST = "到最后一";
Blockly.Msg.TEXT_GET_SUBSTRING_HELPURL = "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";  // untranslated
Blockly.Msg.TEXT_GET_SUBSTRING_INPUT_IN_TEXT = "取文本";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "中首";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "中倒数第";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "中第";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = "个字符的部分文本";
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "返回指定文本中的一小部分文本。";
Blockly.Msg.TEXT_INDEXOF_HELPURL = "https://github.com/google/blockly/wiki/Text#finding-text";  // untranslated
Blockly.Msg.TEXT_INDEXOF_INPUT_INTEXT = "取文本";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = "中首次出现";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "中最后一次出现";
Blockly.Msg.TEXT_INDEXOF_TAIL = "的位置";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "返回在第二个文本中首次或最后一次出现的位置。如果未找到则返回%1。";
...
Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH = "连接文本";
Blockly.Msg.TEXT_JOIN_TOOLTIP = "把多个文本连接成一个文本。";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP = "输出指定的文本、数字或其它值。";
Blockly.Msg.TEXT_PROMPT_HELPURL = "https://github.com/google/blockly/wiki/Text#getting-input-from-the-user";  // untranslated
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER = "提示用户输入数字。";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "提示用户输入一些文本。";
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = "输入文本，并提示";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "输入数字，并提示";
